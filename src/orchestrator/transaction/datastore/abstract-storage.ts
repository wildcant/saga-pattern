...
export abstract class DistributedSchedulerStorage implements IDistributedSchedulerStorage {
  constructor() {
    /* noop */
  }
...
export abstract class DistributedTransactionStorage implements IDistributedTransactionStorage {
  constructor() {
    /* noop */
  }
  ...
  async save(key: string, data: TransactionCheckpoint, ttl?: number): Promise<void> {
  ...
  async clearRetry(transaction: DistributedTransactionType, step: TransactionStep): Promise<void> {
  ...
  async clearTransactionTimeout(transaction: DistributedTransactionType): Promise<void> {
