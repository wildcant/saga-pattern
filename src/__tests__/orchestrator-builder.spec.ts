...
describe('OrchestratorBuilder', () => {
  ...
  it('should merge two action to run in parallel', () => {
    builder.addAction('foo').addAction('bar').addAction('axe').mergeActions('foo', 'axe')
  ...
  it('should delete an action and keep all the next steps of that branch', () => {
    builder.addAction('foo').addAction('bar').addAction('axe').deleteAction('bar')
  ...
  it('should delete an action and remove all the next steps of that branch', () => {
    builder.addAction('foo').addAction('bar').addAction('axe').addAction('step').pruneAction('bar')
    expect(builder.build()).toEqual({
      action: 'foo',
    })
  })
